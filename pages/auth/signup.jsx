      ...
      <div className="m-auto p-12 border w-full md:w-4/12 bg-white shadow-[10px_10px_0px_0px_rgba(0,0,0)] rounded-xl">
        ...
        <div className="mt-12 mx-auto">
          <form className="flex flex-col" onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              className={`mx-4 cursor-pointer w-5/12 ml-auto mr-auto border-2 border-gray-400 rounded-md px-4 py-2 hover:bg-gray-200 transition duration-200 bg-white flex-shrink-0
