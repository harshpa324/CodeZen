      ...
      <div className="m-auto p-12 border w-full md:w-4/12 bg-white  rounded-xl">
        ...
        <div className="mt-12 mx-auto">
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className={`mx-4 cursor-pointer w-4/12 ml-auto mr-auto border-2 border-gray-400 z-10 rounded-md hover:bg-gray-200 px-4 py-2 hover:shadow transition duration-200 bg-white flex-shrink-0
